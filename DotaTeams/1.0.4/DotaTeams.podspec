...
Pod::Spec.new do |s|
  s.name             = 'DotaTeams'
  s.version          = '1.0.4'
  s.summary          = 'Essa biblioteca tem como função principal trazer informações dos times do DOTA 2.'
  s.description      = 'Com o objetivo de trazer mais informações ao seus jogadores, essa lib trará dados completos dos times existente do DOTA 2.'
  s.homepage         = 'https://github.com/VitorNevess/DotaTeams'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Vitor Neves' => 'j.victtor.neves@hotmail.com' }
  s.source           = { :git => 'https://github.com/VitorNevess/DotaTeams.git', :tag => '1.0.4' }#s.version.to_s
...
#  s.default_subspec = 'Release'
  ...
  s.source_files = 'DotaTeams/Classes/**/*.{h,m,swift}'
